...
def require_project_access(
    project_id: str, user: User, db: Session, *, write: bool = False
) -> Project:
...
def require_scenario_access(
    scenario_id: str, user: User, db: Session, *, write: bool = False
) -> Scenario:
...
def require_simulation_access(
    simulation_id: str, user: User, db: Session, *, write: bool = False
) -> SimulationRun:
...
DEFAULT_TEMPLATES = [
    {
        ...
        "category": "scene",
        "title": "电商中型仓模板",
        "description": "适用于日均单量 1-5 万单的电商仓，覆盖高频拣选、打包与出库。",
        "cover": "ecom",
        "industry": "电商",
        "difficulty": "easy",
        "downloads": 1200,
        ...
        "profile": {
            "industries": ["电商", "零售"],
            "daily_orders": [10000, 50000],
            "flows": ["拣选", "打包", "出库"],
            "device_types": ["agv", "station", "charger"],
        },
    },
    {
        "id": "tpl-2",
        "category": "scene",
        "title": "冷链双温区模板",
        "description": "双温区冷链仓库，支持温区隔离、复核工位和低温设备调度。",
        "cover": "coldchain",
        "industry": "冷链",
        "difficulty": "medium",
        "downloads": 987,
    ...
    },
    {
        ...
        "quality_score": 80,
        "profile": {"industries": ["通用"], "flows": ["调度", "拥堵优化"]},
    },
    {
        "id": "tpl-4",
        "category": "report",
    ...
    },
    {
        ...
        "category": "scene",
        "title": "3C 高峰订单模板",
        "description": "面向高密度 SKU 与高峰订单的多拣选工位、分拣缓冲方案。",
        "cover": "3c",
        "industry": "3C",
        "difficulty": "hard",
        "downloads": 1412,
        ...
        "profile": {
            "industries": ["3C", "电子", "数码"],
            "daily_orders": [20000, 80000],
            "flows": ["拣选", "分拣", "打包"],
            "device_types": ["agv", "station", "arm", "charger"],
        },
    },
    {
        "id": "tpl-6",
        "category": "scene",
        "title": "医药合规仓模板",
        "description": "适用于医药追溯、复核与受控出库流程，保留审计和隔离区域。",
        "cover": "medical",
        "industry": "医药",
        "difficulty": "hard",
        "downloads": 1100,
    ...
    },
    {
        ...
        "category": "scene",
        "title": "托盘高位库模板",
        "description": "面向整托入出库的高位货架、缓冲区和托盘 AMR 作业方案。",
        "cover": "pallet",
        "industry": "制造",
        "difficulty": "medium",
        "downloads": 760,
        ...
        "profile": {
            "industries": ["制造", "物流"],
            "daily_orders": [1000, 12000],
            "flows": ["入库", "上架", "出库"],
            "device_types": ["agv", "shelf", "charger"],
        },
    },
]
...
TEMPLATE_SCENARIOS: dict[str, dict[str, Any]] = {
        ...
        "components": [
            {
                ...
                "height": 80,
                "rotation": 0,
                "properties": {"zone": "A", "capacity": 200},
            },
            {
                "id": "shelf-a2",
                "type": "shelf",
        ...
        "components": [
            {
                ...
                "height": 80,
                "rotation": 0,
                "properties": {"zone": "cold", "temperature": "2-8°C"},
            },
            {
                "id": "frozen-shelf-1",
                "type": "shelf",
                ...
                "height": 80,
                "rotation": 0,
                "properties": {"zone": "frozen", "temperature": "-18°C"},
            },
            {
                "id": "cold-station-1",
                "type": "station",
                ...
                "height": 50,
                "rotation": 0,
                "properties": {"station_type": "inspect"},
            },
            {
                "id": "cold-charger-1",
                "type": "charger",
                ...
                "height": 40,
                "rotation": 0,
                "properties": {"temperature_protected": True},
            },
            {
                "id": "cold-agv-1",
                "type": "agv",
                ...
                "height": 24,
                "rotation": 0,
                "properties": {"battery": 88, "temperature_protected": True},
            },
        ],
    },
    "tpl-5": {
        "schema_version": "1.0",
        "canvas": {"width": 1400, "height": 900, "scale": 1},
        "components": [
            {
                "id": "3c-shelf-1",
                "type": "shelf",
                ...
                "height": 80,
                "rotation": 0,
                "properties": {"zone": "A", "capacity": 360},
            },
            {
                "id": "3c-shelf-2",
                "type": "shelf",
                ...
                "height": 80,
                "rotation": 0,
                "properties": {"zone": "B", "capacity": 360},
            },
            {
                "id": "3c-pick-1",
                "type": "station",
            ...
            },
            {
                ...
                "height": 50,
                "rotation": 0,
                "properties": {"agv_type": "tote_amr", "battery": 90},
            },
            {
                "id": "3c-charger-1",
                "type": "charger",
        ...
        "components": [
            {
                ...
                "height": 80,
                "rotation": 0,
                "properties": {"zone": "controlled", "traceable": True},
            },
            {
                "id": "med-inspect",
                "type": "station",
            ...
            },
            {
                ...
                "height": 50,
                "rotation": 0,
                "properties": {"agv_type": "tote_amr", "battery": 92},
            },
            {
                "id": "med-obstacle",
                "type": "obstacle",
    ...
    "tpl-7": {
        "schema_version": "1.0",
        "canvas": {"width": 1500, "height": 900, "scale": 1},
        "components": [
            {
                "id": "pal-shelf-1",
                "type": "shelf",
                ...
                "height": 100,
                "rotation": 0,
                "properties": {"zone": "high-bay", "capacity": 500},
            },
            {
                "id": "pal-shelf-2",
                "type": "shelf",
            ...
            },
            {
                ...
                "height": 70,
                "rotation": 0,
                "properties": {"station_type": "inbound"},
            },
            {
                "id": "pal-outbound",
                "type": "station",
                ...
                "height": 70,
                "rotation": 0,
                "properties": {"station_type": "outbound"},
            },
            {
                "id": "pal-agv",
                "type": "agv",
                ...
                "height": 60,
                "rotation": 0,
                "properties": {"agv_type": "pallet_amr", "battery": 88},
            },
            {
                "id": "pal-charge",
                "type": "charger",
...
def seed_resources(db: Session) -> None:
    ...
    if db.query(LearningResource).count() == 0:
        db.add_all(
            [
                LearningResource(
                    title="仓储建模基础",
                    description="从布局、区域和设备参数开始创建场景。",
                    progress=100,
                    sort_order=10,
                ),
                LearningResource(
                    title="AGV 调度入门",
                    description="理解路径规划、交通管制和冲突处理。",
                    progress=65,
                    sort_order=20,
                ),
                LearningResource(
                    title="仿真与进化决策",
                    description="通过多轮仿真比较策略并应用优化方案。",
                    progress=20,
                    sort_order=30,
                ),
            ]
    ...
    additional_cases = [
        (
            ...
            "medical",
            "\u533b\u836f",
            {"audit": "+45%", "complaint": "-36%", "roi": "18\u4e2a\u6708"},
        ),
        (
            "3C\u5907\u4ef6\u67d4\u6027\u5206\u9009\u4e2d\u5fc3",
            "3c",
            "3C",
            {"efficiency": "+27%", "manpower": "-28%", "roi": "12\u4e2a\u6708"},
        ),
        (
            "\u5236\u9020\u4e1a\u7ebf\u8fb9\u4ed3\u534f\u540c\u914d\u9001",
            "manufacturing",
            "\u5236\u9020",
            {"efficiency": "+22%", "energy": "-15%", "roi": "16\u4e2a\u6708"},
        ),
        (
            "\u5546\u8d85\u96f6\u552e\u591a\u6e29\u533a\u524d\u7f6e\u4ed3",
            "retail",
            "\u96f6\u552e",
            {"efficiency": "+19%", "manpower": "-25%", "roi": "15\u4e2a\u6708"},
        ),
    ]
...
def seed_users(db: Session) -> None:
    # Skip if seeding is disabled or database already has users
    ...
    # Get passwords from settings (via environment variables in production)
    # Default passwords are intentionally weak but will be rejected by the frontend
    # password validation - users must change them on first login.
    seed_passwords = {
        "u-001": settings.seed_admin_password,
        "u-002": settings.seed_demo_password,
        "u-003": settings.seed_demo_password,
    }
        ...
        if db.get(User, user_id) is None:
            db.add(
                User(
                    ...
                    role=role,
                    password_hash=hash_password(seed_passwords.get(user_id, "ChangeMe!")),
...
def seed_scenario_versions(db: Session) -> None:
    ...
    for scenario in db.query(Scenario).all():
        exists = (
            db.query(ScenarioVersion).filter(ScenarioVersion.scenario_id == scenario.id).first()
        )
        if exists is None:
...
class ScenarioService:
    ...
    ) -> tuple[ScenarioData | None, ScenarioValidationRead]:
        try:
    ...
    def auto_layout(self, data: ScenarioData) -> ScenarioAutoLayoutRead:
        ...
        for component in data.components:
            if (
                component.width > data.canvas.width - padding * 2
                or component.height > data.canvas.height - padding * 2
            ):
                raise HTTPException(
                    status_code=422,
                    detail={
                        "code": "LAYOUT_CANVAS_TOO_SMALL",
                        "message": f"画布无法容纳组件 {component.name}",
                    },
                )
